...
public class KafkaProducerSimple {
    public static void main(String[] args) {
         ...
         */
        props.put("metadata.broker.list", "192.168.157.138:9092,192.168.157.139:9092,192.168.157.140:9092");
        /**
         ...
         */
        props.put("partitioner.class", "com.bigdata.kafka.MyLogPartitioner");
        /**
         * 3、通过配置文件，创建生产者
         */
        ...
        for (int messageNo = 1; messageNo < 1000; messageNo++) {
             ...
             */
            producer.send(new KeyedMessage<String, String>(topic, messageNo + "", "wsy" + UUID.randomUUID() + "111"));
        }
    }
}
