package com.bigdata.redis.other;
...
public class MyShardedJedisPool {
    ...
    static {
        ...
        list.add(new JedisShardInfo("192.168.183.136", 6379));
        list.add(new JedisShardInfo("192.168.183.136", 6380));
        list.add(new JedisShardInfo("192.168.183.136", 6381));
        list.add(new JedisShardInfo("192.168.183.136", 6382));
        //创建具有分片功能的的Jedis连接池
